...
public:
    Shader(GLenum type, std::string const &source, std::string const &label="");
...
private:
    std::shared_ptr<GLuint> const _id;
    GLint _getUniformLocation(std::string const &uniform) const;
public:
    Program(std::vector<Shader> const &shaders, std::string const &label="");
    ...
    void setUniform(std::string const &uniform, bool value) const;
    /** Set a floating-point uniform. */
    void setUniform(std::string const &uniform, GLfloat value) const;
    /** Set an integer uniform. */
    void setUniform(std::string const &uniform, GLint value) const;
    /** Set an unsigned integer uniform. */
    void setUniform(std::string const &uniform, GLuint value) const;
    /** Set a vec2 uniform. */
    void setUniform(std::string const &uniform, glm::vec2 const &value) const;
    /** Set a vec3 uniform. */
    void setUniform(std::string const &uniform, glm::vec3 const &value) const;
    /** Set a vec4 uniform. */
    void setUniform(std::string const &uniform, glm::vec4 const &value) const;
    /** Set a mat4 uniform. */
    void setUniform(std::string const &uniform, glm::mat4 const &value) const;
    /**
...
public:
    ...
    Buffer(GLenum target, std::string const &label="");
...
private:
    std::shared_ptr<GLuint> const _id;
public:
    VertexArray(std::string const &label="");
...
public:
     ...
     * target!
     */
    Texture(GLenum type, std::string const &label="");
...
Shader shader_from_file(std::string const &path, GLenum type);
}
