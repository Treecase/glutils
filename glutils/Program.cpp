...
GLUtil::Program::Program(
    std::vector<Shader> const &shaders, std::string const &label)
...
void GLUtil::Program::setUniform(std::string const &uniform, bool value) const
{
    glUniform1i(_getUniformLocation(uniform), value);
}

void GLUtil::Program::setUniform(std::string const &uniform, GLfloat value) const
{
    glUniform1f(_getUniformLocation(uniform), value);
}

void GLUtil::Program::setUniform(std::string const &uniform, GLint value) const
{
    glUniform1i(_getUniformLocation(uniform), value);
}

void GLUtil::Program::setUniform(std::string const &uniform, GLuint value) const
{
    glUniform1ui(_getUniformLocation(uniform), value);
}

void GLUtil::Program::setUniform(std::string const &uniform, glm::vec2 const &value) const
{
    glUniform2fv(_getUniformLocation(uniform), 1, glm::value_ptr(value));
}

void GLUtil::Program::setUniform(std::string const &uniform, glm::vec3 const &value) const
{
    glUniform3fv(_getUniformLocation(uniform), 1, glm::value_ptr(value));
}

void GLUtil::Program::setUniform(std::string const &uniform, glm::vec4 const &value) const
{
    glUniform4fv(_getUniformLocation(uniform), 1, glm::value_ptr(value));
}

void GLUtil::Program::setUniform(std::string const &uniform, glm::mat4 const &value) const
{
    glUniformMatrix4fv(
...
GLint GLUtil::Program::_getUniformLocation(std::string const &uniform) const
{
    auto location = glGetUniformLocation(*_id, uniform.c_str());
    if (location == -1)
        throw std::runtime_error{"uniform '" + uniform + "' does not exist"};
    return location;
}
